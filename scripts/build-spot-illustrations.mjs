...
const PANORAMA = `
  ...
  <g fill="#F7ECCC">
    ...
    <ellipse cx="680" cy="110" rx="62" ry="21"/><ellipse cx="630" cy="96" rx="34" ry="14"/>
    <ellipse cx="1080" cy="70" rx="56" ry="19"/><ellipse cx="1124" cy="58" rx="32" ry="13"/>
    <ellipse cx="1560" cy="98" rx="60" ry="20"/><ellipse cx="1512" cy="84" rx="34" ry="14"/>
    <ellipse cx="1980" cy="74" rx="58" ry="20"/><ellipse cx="2026" cy="60" rx="34" ry="14"/>
  ...
  <!-- continuous downtown silhouette -->
  <g fill="#35917E">
  ...
  <g>
    ...
    <g fill="#35917E">
      <rect x="1122" y="316" width="10" height="60"/><rect x="1144" y="316" width="10" height="60"/>
      <rect x="1166" y="316" width="10" height="60"/><rect x="1188" y="316" width="10" height="60"/>
      <rect x="1210" y="316" width="8" height="60"/>
    </g>
  </g>
  <!-- rolling tree canopy -->
  <g fill="#368A59">
    <circle cx="70" cy="392" r="56"/><circle cx="200" cy="406" r="46"/><circle cx="340" cy="396" r="52"/>
    <circle cx="500" cy="408" r="44"/><circle cx="640" cy="394" r="54"/><circle cx="790" cy="404" r="48"/>
    <circle cx="930" cy="392" r="52"/><circle cx="1070" cy="406" r="46"/><circle cx="1230" cy="398" r="50"/>
    <circle cx="1380" cy="408" r="44"/><circle cx="1520" cy="392" r="54"/><circle cx="1660" cy="404" r="48"/>
    <circle cx="1800" cy="394" r="52"/><circle cx="1950" cy="406" r="46"/><circle cx="2090" cy="396" r="52"/>
    <circle cx="2230" cy="408" r="44"/><circle cx="2360" cy="394" r="52"/>
  </g>
  <g fill="#2B6E49">
    <circle cx="0" cy="420" r="44"/><circle cx="420" cy="424" r="40"/><circle cx="860" cy="420" r="42"/>
    <circle cx="1300" cy="424" r="40"/><circle cx="1740" cy="420" r="42"/><circle cx="2180" cy="424" r="40"/><circle cx="2400" cy="418" r="44"/>
  </g>
  <!-- ground -->
