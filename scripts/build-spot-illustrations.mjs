...
const PANORAMA = `
  ...
  <!-- clouds: mixed puffy + ellipse forms, echoing the hero banner -->
  <g fill="#F7ECCC">
  ...
  <!-- continuous downtown silhouette: varied building forms -->
  <g fill="#35917E">
  ...
  <!-- tree canopy: round, blob, and oval forms mixed per scene -->
  <g fill="#368A59">
  ...
  <g fill="#2B6E49">
    <ellipse cx="0" cy="424" rx="46" ry="36"/><circle cx="420" cy="424" r="40"/><ellipse cx="860" cy="424" rx="46" ry="36"/>
    <circle cx="1300" cy="424" r="40"/><ellipse cx="1740" cy="424" rx="44" ry="36"/><circle cx="2180" cy="424" r="40"/><ellipse cx="2400" cy="420" rx="46" ry="38"/>
  </g>
  <!-- one fall tree, garden end (echoes the hero's autumn tree) -->
  <g>
